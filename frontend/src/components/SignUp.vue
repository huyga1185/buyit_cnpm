    ...
    <div class="bg">
        <div class="container">
            <div class="wrapper row">
                ...
                <div class="signup-section col-4">
                    <h1 class="signup-section__header">Đăng ký</h1>
                    <form @submit.prevent="handleLogin">
                        <div class="signup-section__items">       
                            <input type="text" id="email" v-model="email" placeholder="Nhập email" class="item__email">
                            ...
                            <input type="password" v-model="re_password" placeholder="Nhập lại mật khẩu" class="item__password" id="re-password">
                            <button type="submit" class="item__submit-btn"  :disabled="isDisable" :style="{ cursor: pointer, background: colorBtn}">Đăng ký</button>
                            <div v-if="error" class="item__error"> 
                                <IconCircleXMark class="item__error-icon"/>
                                {{ error }}
                            </div>
                            <div class="item__term-and-condition-section">
                                <p class="item__term-and-condition">
                                    Bằng việc đăng ký bạn đã đồng ý với chúng tôi
                                    <router-link to="/" class="item__link"> Điều khoản dịch vụ</router-link>
                                </p>
                            </div>
                            ...
                            <div class="item__signup-section">
                                <p class="item__signup">
                                    <label for="signup" class="signup__title">Bạn đã có tài khoản?</label>
                                    <router-link to="/login" class="item__link" id="signup"> Đăng nhập</router-link>
                                </p>
                            </div>
                        </div>
                    </form>
